...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("role", sa.Enum("FARMER", "ADMIN", "RESEARCHER", name="userrole"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("season", sa.Enum("KHARIF", "RABI", "SUMMER", "YEAR_ROUND", name="season"), nullable=True),
